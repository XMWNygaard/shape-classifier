...
namespace ShapeIdentifier.Tests
{
    ...
    public class TriangleTest
    {
        ...
        public void IsValidBySides_ShouldReturnTrue_WhenTwoSidesSummedAreGreaterThanTheThirdSide(decimal a, decimal b, decimal c)
        {
            Assert.IsTrue(_cut.IsValidBySides(a, b, c));
        }
